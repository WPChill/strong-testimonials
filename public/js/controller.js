...
var strongController = {
  ...
  start: function () {
    ...
    // window.addEventListener( 'load', strongController.initLayouts, false );
    // window.addEventListener( 'load', function() { setTimeout( strongController.initLayouts, 100 ); }, false );
