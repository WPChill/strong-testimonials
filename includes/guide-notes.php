	<div class="guide-content notes">
		...
		<p><?php _e( 'There is a .pot file in the plugin\'s <code>languages</code> directory. <a href="http://www.wpmission.com/contact/" target=_blank">Contact me</a> to submit a translation file.', 'strong-testimonials' ); ?></p>
		<p><?php _e( 'The field labels on the submission form will not appear in the .pot file so they must be translated manually in the <a href="edit.php?post_type=wpm-testimonial&page=fields">Fields editor</a>.', 'strong-testimonials' ); ?></p>
		...
		<p><?php _e( 'Please use the <a href="http://wordpress.org/support/plugin/strong-testimonials" target="_blank">support forum</a> or <a href="http://www.wpmission.com/contact/" target="_blank">contact me</a>.', 'strong-testimonials' ); ?></p>
