...
<th colspan="2">
	<div>
		<div class="inline checkbox">
			...
			<label for="view-more_post"><?php _e( '"Read more" link to the testimonial', 'strong-testimonials' ); ?></label>
		</div>
		<div class="inline then_more_post">
			<label for="view-more_text"><?php _e( 'Link text', 'strong-testimonials' ); ?></label>
