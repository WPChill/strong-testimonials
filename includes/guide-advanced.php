	<div class="guide-content">
		...
		<p>
			<em><?php printf( __( 'View some examples on the <a href="%s" target="_blank">demo site</a>.', 'strong-testimonials' ), 'http://demos.wpmission.com/strong-testimonials/' ); ?></em>
		</p>
		...
		<table class="guide">
			<tr>
				...
				<td class="features">
					<ul class="features">
						<li>
							<strong><a href="edit.php?post_type=wpm-testimonial&page=fields"><?php _e( 'Fields', 'strong-testimonials' ); ?></a></strong> - <?php _e( 'Customize the form to meet your needs.', 'strong-testimonials' ); ?> <?php printf( __( '<a href="%s" target="_blank">Here</a> is a full tutorial.', 'strong-testimonials' ), 'http://www.wpmission.com/tutorials/customize-the-form-in-strong-testimonials/' ); ?>
						</li>
						<li>
							<strong><a href="edit.php?post_type=wpm-testimonial"><?php _e( 'Featured Images', 'strong-testimonials' ); ?></a></strong> - <?php _e( 'AKA thumbnails.', 'strong-testimonials' ); ?> <?php _e( 'Allow your clients to include a photo or a logo with their testimonial.', 'strong-testimonials' ); ?>
						</li>
						<li>
							<strong><a href="edit.php?post_type=wpm-testimonial&page=settings"><?php _e( 'Spam Control', 'strong-testimonials' ); ?></a></strong> - <?php _e( 'Add honeypot and/or Captcha  methods to the form.', 'strong-testimonials' ); ?>
						</li>
						<li>
							<strong><a href="edit.php?post_type=wpm-testimonial&page=settings"><?php _e( 'Notification', 'strong-testimonials' ); ?></a></strong> - <?php _e( 'Automatically send an email to the site administrator when a new testimonial has been submitted and is pending review.', 'strong-testimonials' ); ?>
						</li>
					</ul>
				</td>
			</tr>
