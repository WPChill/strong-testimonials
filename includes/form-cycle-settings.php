		...
		<div class="radio">
			<label>
				...
				<p class="description">
					...
					<div class="screenshot" id="screenshot-screen-options"><div style="background: url(<?php echo WPMTST_DIR; ?>/images/screen-options.png); height: 241px; width: 730px;"></div></div>
				</p>
			</label>
		</div>
