...
class Strong_Testimonials_Help {
	...
	public static function views_list() {
        ...
        <div>
            ...
            <p><?php wp_kses_post( _e( 'You can create an <strong>unlimited</strong> number of views.', 'strong-testimonials' ) ); ?></p>
	...
	public static function view_editor_stretch() {
		...
		ob_start();
		?>
        <p><?php wp_kses_post( _e( 'This will set the height of the <b>slideshow container</b> to match the tallest slide in order to keep elements below it from bouncing up and down during slide transitions. With testimonials of uneven length, the result is whitespace underneath the shorter testimonials.', 'strong-testimonials' ) ); ?></p>
        <p><?php wp_kses_post( _e( 'Select the <b>Stretch</b> option to stretch the borders and background vertically to compensate.', 'strong-testimonials' ) ); ?></p>
