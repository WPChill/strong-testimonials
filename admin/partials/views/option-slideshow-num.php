    ...
    <div class="row">
        ...
        <div class="inline inline-middle">
            ...
            <select id="view-max_slides" name="view[data][slideshow_settings][max_slides]" class="if selectgroup">
                ...
                <option value="4" <?php selected( $view['slideshow_settings']['max_slides'], 4 ); ?>>4</option>
            </select>
        ...
        <div class="inline then then_max_slides then_not_1 then_2 then_3 then_4" style="display: none;">
