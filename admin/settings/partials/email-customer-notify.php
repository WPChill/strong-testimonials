    ...
    <div class="email-option-inputs">
        <div class="email-option body">
            <input class="wide"
                    ...
                    name="wpmtst_form_options[customer_email_subject]"
                    value="<?php echo esc_attr( $form_options['customer_email_subject'] ); ?>"
...
<div class="email-option-row">
    ...
    <?php $line_count = max( count( explode( "\n", $form_options['customer_email_message'] ) ), 3 ); ?>
    <div class="email-option-inputs">
        <div class="email-option body">
            <textarea class="autosize"
                id="wpmtst-option-email-message" name="wpmtst_form_options[customer_email_message]"
                rows="<?php echo esc_attr( $line_count ); ?>"
                placeholder="<?php _e( 'message text', 'strong-testimonials' ); ?>"><?php echo esc_attr( $form_options['customer_email_message'] ); ?></textarea>
        </div>
    </div>
