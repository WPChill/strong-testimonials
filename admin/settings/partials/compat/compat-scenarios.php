...
<tr valign="top">
    ...
    <div class="scenarios">
      ...
      <div class="row">
        ...
        <div>
            <p><?php _e( '<strong>Prerender</strong>: All views<br/><strong>Ajax Page Loading</strong>: Universal', 'strong-testimonials' ); ?></p>
            <p><a href="#" id="set-scenario-1"><?php _ex( 'Set these now', 'link text on Settings > Compatibility tab', 'strong-testimonials' ); ?></a></p>
        </div>
      </div>
    </div>
