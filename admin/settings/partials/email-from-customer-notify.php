                    ...
                    <div class="email-option-fieldset">
                        ...
                        <div class="fields">
                            <input type="text"
                                   ...
                                   name="wpmtst_form_options[sender_name_for_customer]"
                                   value="<?php echo esc_attr( $form_options['sender_name_for_customer'] ); ?>"
                    ...
                    <div class="email-option-fieldset">
                        ...
                        <div class="controls">
                            <input type="radio"
                                   ...
                                   name="wpmtst_form_options[sender_site_customer_email]" <?php checked( $form_options['sender_site_customer_email'], 1 ); ?>
                                   value="1">
                        </div>
                        <div class="fields">
                    ...
                    <div class="email-option-fieldset">
                        ...
                        <div class="controls">
                            <input class="focus-next-field" type="radio"
                                   id="wpmtst-options-sender_site_customer_email-0"
                                   name="wpmtst_form_options[sender_site_customer_email]" <?php checked( $form_options['sender_site_customer_email'], 0 ); ?>
                                   value="0">
                        </div>
                        <div class="fields">
                            <input type="email"
                                   id="wpmtst-options-sender-site-customer-email"
                                   name="wpmtst_form_options[sender_customer_email]"
                                   value="<?php echo esc_attr( $form_options['sender_customer_email'] ); ?>"
