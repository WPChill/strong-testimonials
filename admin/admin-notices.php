...
function wpmtst_admin_notice_text( $html = '', $key, $persist = false ) {
	...
	switch ( $key ) {
		case 'defaults-restored':
			ob_start();
			?>
			<div class="wpmtst notice notice-success is-dismissible" data-key="<?php esc_attr( $key ); ?>">
				<p>
		...
		case 'captcha-options-changed':
			...
			ob_start();
			?>
			<div class="wpmtst notice notice-warning is-dismissible" data-key="<?php esc_attr( $key ); ?>">
				<p>
