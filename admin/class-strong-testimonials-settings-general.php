...
class Strong_Testimonials_Settings_General {
	...
	public static function register_settings() {
		...
		register_setting( 'wpmtst-form-group', 'wpmtst_form_options', array( __CLASS__, 'sanitize_form_options' ) );
		register_setting( 'wpmtst-license-group', 'wpmtst_addons', array( __CLASS__, 'sanitize_licenses' ) );
	}
	 ...
	 * @return mixed
	 */
	public static function sanitize_form_options( $input ) {
	 ...
	 * @return mixed
	 */
	public static function sanitize_licenses( $new_licenses ) {
		...
		<div class="wrap wpmtst">
			...
			<form id="<?php echo $active_tab; ?>-form" method="post" action="options.php">
				...
				$callbacks = apply_filters( 'wpmtst_settings_callbacks', array(
					'general'  => array( __CLASS__, 'settings_general' ),
					'form'     => array( __CLASS__, 'settings_form' ),
					'licenses' => array( __CLASS__, 'settings_licenses' ),
				) );
	...
	public static function settings_form() {
		...
		include( WPMTST_ADMIN . 'partials/settings/form.php' );
	}

	/**
	 * License settings.
	 */
	public static function settings_licenses() {
