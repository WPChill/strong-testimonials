...
<p class="lead-description"><?php _e( 'The highest-rated free testimonials plugin trusted by more than 30,000 people keeps getting better.', 'strong-testimonials' ); ?></p>
<div class="feature-section one-col">
    <div class="col">
        ...
        <p><?php _e( 'Power up with plugins like Popup Maker or Captcha. For developers, actions and filters allow further customization.', 'strong-testimonials' ); ?></p>
    </div>
</div>
