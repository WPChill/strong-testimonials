			...
			<div class="container">
				...
				<div class="hero features">
					...
					<div class="block">
                        ...
                        <?php $welcome->display_extension( esc_html__( 'Country Selector', 'strong-testimonials' ), esc_html__( 'Easily add a form field to allow your customers to submit testimonials with their country information.', 'strong-testimonials' ),  esc_url( WPMTST_ADMIN_URL). "/img/features/country-selector.png", true ); ?>
